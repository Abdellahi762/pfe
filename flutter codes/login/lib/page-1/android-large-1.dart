            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 21*fem,
                  child: Image.asset(
                    'assets/page-1/images/vector-zk3.png',
                    width: 18*fem,
                    height: 21*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 15.56*fem,
                  child: Image.asset(
                    'assets/page-1/images/vector-QQB.png',
                    width: 18*fem,
                    height: 15.56*fem,
                  ),
                ),
              ...
              child: Align(
                child: SizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration (
                      borderRadius: BorderRadius.circular(12*fem),
                      border: Border.all(color: Color(0xff2f6c60)),
                    ),
                  ),
                ),
              ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 15.56*fem,
                  child: Image.asset(
                    'assets/page-1/images/vector-zTm.png',
                    width: 18*fem,
                    height: 15.56*fem,
                  ),
                ),
